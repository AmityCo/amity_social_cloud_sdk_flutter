...
abstract class ChannelEventListener extends MQTTEventListener {
  @override
  ...
  bool isActiveUserEvent(CreateChannelResponse data,
      bool Function(ChannelUserResponse membership) condition) {

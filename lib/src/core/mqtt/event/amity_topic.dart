...
abstract class AmityTopic {
  ...
  factory AmityTopic.LIVE_STREAM(String networkId) = AmityTopicLiveStream;
...
///  Amity Topic for LiveStream
class AmityTopicLiveStream extends AmityTopic {
  final String networkId;
  AmityTopicLiveStream(this.networkId) : super._('livestream', networkId, "");

  @override
  String generateTopic() {
    return "$networkId/videostreaming";
  }
}
